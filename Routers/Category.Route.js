...
route.put('/put/:id',(req,res) =>{
    categorys.updateOneCategory(req.params.id,req.body.name,req.body.description,req.body.image,req.body.type)
...
route.post('/post',(req,res) =>{
    categorys.postNewCategory(req.body.name,req.body.description,req.body.image,req.body.idService,req.body.type)
